      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 pb-4 border-b border-slate-100">
        <div>
          <div className="flex items-center gap-2 flex-wrap mb-1">
            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-emerald-50 text-emerald-800 border border-emerald-200 text-[11px] font-black uppercase tracking-wider">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="text-[11px] text-slate-500 hover:text-emerald-700 font-bold flex items-center gap-1 hover:underline"
            >
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
          ...
          <div className="relative w-full sm:w-56">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 bg-slate-50 border border-slate-300 rounded-xl text-xs text-slate-900 font-medium placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
            />
          </div>
        </div>
      </div>
            ...
            {filtered.map((curr) => {
              ...
              return (
                <tr key={curr.code} className="hover:bg-slate-50 transition-colors">
                  <td className="py-3.5 flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-extrabold text-slate-900 text-sm flex items-center gap-1.5">
                        {curr.code}
                        {curr.popular && (
                          <span className="px-1.5 py-0.5 text-[9px] bg-emerald-50 text-emerald-700 font-bold rounded border border-emerald-200">
                            Popular
                          </span>
                        )}
                      </div>
                  ...
                  <td className="py-3.5 text-right font-black text-emerald-700 text-sm sm:text-base">
                  ...
                  <td className="py-3.5 text-right font-bold">
                    <span className={curr.change24h >= 0 ? 'text-emerald-700' : 'text-rose-600'}>
                  ...
                  <td className="py-3.5 text-center">
                    <div className="flex items-center justify-center gap-2">
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 bg-emerald-600 hover:bg-emerald-500 text-white font-extrabold text-xs rounded-lg transition-all flex items-center gap-1 shadow-sm cursor-pointer"
                      >
