...
export default function MobileBottomNav({
  ...
  return (
    <div className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-[#0F1115]/95 backdrop-blur-xl border-t border-slate-800 shadow-[0_-8px_25px_rgba(0,0,0,0.8)] px-2 py-1.5 flex items-center justify-around">
      {items.map((item) => {
      ...
      >
        <div className="relative">
          ...
          {cartCount > 0 && (
            <span className="absolute -top-1.5 -right-2 px-1.5 py-0.2 text-[9px] font-black text-black bg-teal-400 rounded-full border border-slate-900 shadow">
              {cartCount}
            </span>
          )}
        </div>
