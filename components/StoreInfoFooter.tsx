...
import { MapPin, PhoneCall, Clock, ShieldCheck, Mail, MessageCircle, ExternalLink } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 pb-10 border-b border-slate-800/80">
          ...
          <div className="space-y-3">
            ...
            <div className="p-3 rounded-xl bg-[#12151C] border border-slate-800 text-xs space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-bold text-teal-400">10:00 AM - 6:00 PM</span>
              </div>
            </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="text-xs space-y-2 text-slate-400">
              <li className="hover:text-teal-300 transition-colors cursor-pointer">• 0% Commission Foreign Exchange</li>
              <li className="hover:text-teal-300 transition-colors cursor-pointer">• Certified Unlocked iPhone & Samsung Sales</li>
              <li className="hover:text-teal-300 transition-colors cursor-pointer">• Pre-owned Phone Cash Trade-In</li>
              <li className="hover:text-teal-300 transition-colors cursor-pointer">• 65W GaN Travel Fast Chargers & Power Banks</li>
              <li className="hover:text-teal-300 transition-colors cursor-pointer">• Global Travel eSIM Passes</li>
            </ul>
          </div>
