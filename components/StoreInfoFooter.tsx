...
export const StoreInfoFooter: React.FC = () => {
  return (
    <footer id="store-location" className="bg-slate-900 border-t border-slate-800 text-slate-300 pt-12 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 pb-10 border-b border-slate-800">
          ...
          <div className="space-y-3">
            ...
            <div className="p-3.5 rounded-xl bg-slate-800/80 border border-slate-700/80 text-xs space-y-2 font-medium">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-bold text-emerald-400">10:00 AM - 6:00 PM</span>
              </div>
            </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="text-xs space-y-2 text-slate-400 font-medium">
              <li className="hover:text-emerald-400 transition-colors cursor-pointer">• 0% Commission Foreign Exchange</li>
              <li className="hover:text-emerald-400 transition-colors cursor-pointer">• Certified Unlocked iPhone & Samsung Sales</li>
              <li className="hover:text-emerald-400 transition-colors cursor-pointer">• Pre-owned Phone Cash Trade-In</li>
              <li className="hover:text-emerald-400 transition-colors cursor-pointer">• 65W GaN Travel Fast Chargers & Power Banks</li>
              <li className="hover:text-emerald-400 transition-colors cursor-pointer">• Global Travel eSIM Passes</li>
            </ul>
          </div>
