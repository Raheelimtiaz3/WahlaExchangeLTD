...
export const AiAdvisor: React.FC = () => {
  ...
  const quickPresets = [
    { label: 'Japan Trip Plan', dest: 'Japan', days: 10, budget: 2500 },
    ...
    { label: 'USA Shopping & Tech', dest: 'United States', days: 7, budget: 3000 },
  ];
      ...
      <div className="bg-white border border-slate-200/90 rounded-3xl p-6 sm:p-8 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden">
          ...
          <div className="flex items-center gap-2 overflow-x-auto pb-1">
            {quickPresets.map((p) => (
              <button
                ...
                className="px-3 py-1.5 rounded-xl text-xs font-extrabold bg-slate-50 hover:bg-slate-100 border border-slate-200 text-slate-700 transition-all shrink-0 flex items-center gap-1.5 cursor-pointer"
              >
                <span>{p.label}</span>
              </button>
            ))}
        ...
        <form onSubmit={handleGenerate} className="grid grid-cols-1 md:grid-cols-12 gap-4 mb-6">
          ...
          <div className="md:col-span-2">
            <label className="block text-xs font-bold text-slate-700 mb-1">Trip Days</label>
            <input
              type="number"
              value={days}
          ...
          <div className="md:col-span-3">
            <label className="block text-xs font-bold text-slate-700 mb-1">Budget ($ USD / £ GBP)</label>
            <input
              type="number"
              value={budgetUsd}
          ...
          <div className="md:col-span-4">
            <label className="block text-xs font-bold text-slate-700 mb-1">Your Phone Model</label>
            <input
              type="text"
              value={phoneModel}
          ...
          <div className="md:col-span-12">
            <label className="block text-xs font-bold text-slate-700 mb-1">Specific Question or Notes (Optional)</label>
