      ...
      <div className="w-full max-w-md bg-white border-l border-slate-200 text-slate-900 flex flex-col justify-between h-full shadow-2xl">
        ...
        <div className="p-4 sm:p-5 border-b border-slate-100 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs bg-emerald-50 text-emerald-800 px-2 py-0.5 rounded border border-emerald-200 font-bold">
              {items.length} items
            </span>
          </div>
            ...
            items.map((item) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <span className="text-xs font-black text-emerald-700">£{item.price.toFixed(2)}</span>
                </div>
        ...
        {items.length > 0 && (
          <div className="p-4 sm:p-5 border-t border-slate-100 bg-slate-50 space-y-3">
            ...
            <button
              ...
              className="w-full py-3.5 bg-emerald-600 hover:bg-emerald-500 text-white font-black text-sm rounded-xl transition-all flex items-center justify-center gap-2 shadow-sm cursor-pointer"
            >
