...
export default function StoreLocator({ onSelectBranch }: StoreLocatorProps) {
  ...
  return (
    <div id="locations" className="bg-white border border-slate-200/90 rounded-3xl p-5 sm:p-8 space-y-6 shadow-sm hover:shadow-md transition-shadow">
      {/* Header */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 border-b border-slate-100 pb-5">
        <div>
          <div className="flex items-center gap-2 flex-wrap">
            <span className="text-xs font-black text-blue-800 uppercase tracking-wider bg-blue-50 px-2.5 py-1 rounded-md border border-blue-200 flex items-center gap-1">
              <MapPin className="w-3.5 h-3.5 text-blue-600" /> Physical Counter Locations
            </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start">
                ...
                <div className="flex items-center justify-between mt-3 pt-3 border-t border-slate-200/80 text-[11px] text-slate-600 font-medium">
                  <div className="flex items-center gap-3">
                    <span className="flex items-center gap-1">
                      <Clock className="w-3.5 h-3.5 text-blue-600" /> {b.hours}
                    </span>
                    <span className="flex items-center gap-1">
                  ...
                  {b.googleMapsUrl && (
                    <a
                      ...
                      className="text-blue-700 hover:text-blue-600 font-bold flex items-center gap-1 text-[11px] hover:underline"
                    >
        ...
        <div className="lg:col-span-6 bg-slate-50 border border-slate-200 rounded-2xl p-5 sm:p-6 space-y-4 shadow-xs">
          <div className="border-b border-slate-200 pb-3 flex flex-wrap items-center justify-between gap-2">
            <div>
              <span className="text-[10px] text-blue-800 font-extrabold uppercase tracking-wider">
            ...
            <div className="space-y-3">
              <div className="relative w-full h-64 sm:h-72 rounded-xl overflow-hidden border border-slate-200 bg-white">
                <iframe
                  ...
                  allowFullScreen
                />
                <div className="absolute top-2.5 left-2.5 px-3 py-1 rounded-full bg-slate-950/90 text-[10px] font-bold text-white shadow flex items-center gap-1.5">
              ...
              <div className="p-3 rounded-xl bg-white border border-slate-200 flex items-center justify-between text-xs gap-2">
                ...
                {selectedBranch.googleMapsUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-3 py-1.5 rounded-lg bg-blue-50 border border-blue-200 text-blue-800 font-extrabold text-[11px] hover:bg-blue-100 transition-colors flex items-center gap-1 shrink-0"
                  >
            ...
            <div className="space-y-3 text-xs">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="p-3 rounded-xl bg-white border border-slate-200">
                  ...
                  <p className="text-blue-700 font-bold font-mono mt-0.5">{selectedBranch.phone}</p>
                </div>
              </div>
          ...
          <div className="pt-2 flex flex-col sm:flex-row gap-2.5">
            <button
              ...
              className="flex-1 py-3 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-black text-xs flex items-center justify-center gap-2 shadow-xs transition-all uppercase tracking-wider cursor-pointer"
            >
